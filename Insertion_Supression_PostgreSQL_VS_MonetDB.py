...
def main():
    with tqdm(total=6, desc="Progression globale", unit="étapes") as pbar:
        ...
        plot_results(i_postgres_avg_times_2.keys(), i_postgres_avg_times_2, i_postgres_std_times_2, i_monet_avg_times_2, i_monet_std_times_2, "Nombre de lignes insérées", "Temps d'insertion (s)", "Performance d'insertion : PostgreSQL vs MonetDB avec 2 attributs", "PostgreSQL", "MonetDB")
        plot_results(d_postgres_avg_times_2.keys(), d_postgres_avg_times_2, d_postgres_std_times_2, d_monet_avg_times_2, d_monet_std_times_2, "Nombre de lignes supprimées", "Temps de suprresion (s)", "Performance de suprresion : PostgreSQL vs MonetDB avec 2 attributs", "PostgreSQL", "MonetDB")
        plot_results(i_postgres_avg_times_6.keys(), i_postgres_avg_times_6, i_postgres_std_times_6, i_monet_avg_times_6, i_monet_std_times_6, "Nombre de lignes insérées", "Temps d'insertion (s)", "Performance d'insertion : PostgreSQL vs MonetDB avec 6 attributs", "PostgreSQL", "MonetDB")
        plot_results(d_postgres_avg_times_6.keys(), d_postgres_avg_times_6, d_postgres_std_times_6, d_monet_avg_times_6, d_monet_std_times_6, "Nombre de lignes supprimées", "Temps de suprresion (s)", "Performance de suprresion : PostgreSQL vs MonetDB avec 6 attributs", "PostgreSQL", "MonetDB")
        plot_results(i_postgres_avg_times_6.keys(), i_postgres_avg_times_2, i_postgres_std_times_2, i_postgres_avg_times_6, i_postgres_std_times_6, "Nombre de lignes insérées", "Temps d'insertion (s)", "Performance d'insertion PostgreSQL : 2 vs 6 attributs", "2 attributs", "6 attributs")
        plot_results(d_postgres_avg_times_6.keys(), d_postgres_avg_times_2, d_postgres_std_times_2, d_postgres_std_times_6, d_postgres_std_times_6, "Nombre de lignes supprimées", "Temps de suprresion (s)", "Performance de suprresion PostgreSQL : 2 vs 6 attributs", "2 attributs", "6 attributs")
        plot_results(i_monet_avg_times_6.keys(), i_monet_avg_times_2, i_monet_std_times_2, i_monet_avg_times_6, i_monet_std_times_6, "Nombre de lignes insérées", "Temps d'insertion (s)", "Performance d'insertion MonetDB : 2 vs 6 attributs", "2 attributs", "6 attributs")
        plot_results(d_monet_avg_times_6.keys(), d_monet_avg_times_2, d_monet_std_times_2, d_monet_avg_times_6, d_monet_std_times_6, "Nombre de lignes supprimées", "Temps de suprresion (s)", "Performance de suprresion MonetDB : 2 vs 6 attributs", "2 attributs", "6 attributs")
